...
- 이론
- 실습 프로젝트 
  - 70. Jenkins와 Docker를 이용한 배포 자동화하기(계속)
    - 가상화와 도커
    - 도커 사용법
- 최종 프로젝트
  - 구현 
...
- 실습 프로젝트 
  - 70. Jenkins와 Docker를 이용한 배포 자동화하기(계속)
    - Jenkins 구축하기
    - WebHook을 이용하여 깃허브와 젠킨스 연동하기
    - 배치용 리눅스 서버 생성
    - 깃허브와 젠킨스, 도커를 이용한 자동 배치
- 최종 프로젝트
  - 구현
...
- 이론
  - 자바스크립트 프로그래밍
    - AJAX 사용법 : XMLHttpRequest 사용하기
- 실습 프로젝트 
- 최종 프로젝트
  - 구현 및 리뷰
    - 4팀, 1팀, 2팀, 3팀, 

## NCP 강의(2024-11-18 ~ 26, 7일)

- Naver Cloud Platform 사용법
  - 네이버 클라우드 강사 강의 
